...
public class UnosUslugaController {
	private Logger log =  LoggerFactory.getLogger(UnosUslugaController.class);
	...
	public void unesi() {
		...
		Usluga usluga = new Usluga(tmpNaslov, tmpOpis, tmpCijena, tmpStanje, -1);
		try{	
		...
		alert.setHeaderText("");
		alert.setContentText("Uspjesno unesena usluga\n");
		alert.showAndWait();
	}
